...
$scope.addItem = function(itemName, itemCol, itemTime, itemPower) {
     if (userData.user.items.length < 16) userData.user.items.push({name: itemName, color: donutChart.getRandCol(), col: itemCol||1, time: itemTime||60, power: itemPower||200});
...
this.changeData = function () {return changeData();};
